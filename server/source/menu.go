...
var menus = []system.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 200, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "things", Name: "things", Hidden: false, Component: "view/things/device/index.vue", Sort: 2, Meta: system.Meta{Title: "物联网", Icon: "upload"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 201, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "productList", Name: "productList", Hidden: false, Component: "view/things/device/productInfo/productList.vue", Sort: 2, Meta: system.Meta{Title: "产品列表", Icon: "goods"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 202, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "deviceList", Name: "deviceList", Hidden: true, Component: "view/things/device/deviceInfo/deviceList.vue", Sort: 2, Meta: system.Meta{Title: "设备列表", Icon: "headset"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 203, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "userGroup", Name: "userGroup", Hidden: true, Component: "view/things/user/userGroup/index.vue", Sort: 2, Meta: system.Meta{Title: "用户及设备组管理", Icon: "headset"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 204, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "groupInfo", Name: "groupInfo", Hidden: true, Component: "view/things/device/group/groupInfo.vue", Sort: 2, Meta: system.Meta{Title: "设备及用户组", Icon: "headset"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 205, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "productDetail", Name: "productDetail", Hidden: true, Component: "view/things/device/productInfo/productDetail/index.vue", Sort: 2, Meta: system.Meta{Title: "产品详情", Icon: "headset"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 206, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "clientList", Name: "clientList", Hidden: false, Component: "view/things/user/userInfo/index.vue", Sort: 2, Meta: system.Meta{Title: "用户列表", Icon: "headset"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 207, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "200", Path: "deviceDetail", Name: "deviceDetail", Hidden: true, Component: "view/things/device/deviceInfo/deviceDetail/index.vue", Sort: 2, Meta: system.Meta{Title: "设备详情", Icon: "headset"}},
}
